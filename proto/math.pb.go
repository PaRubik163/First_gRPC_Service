...
const file_proto_math_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\x03R\x06result2u\n" +
	"\vMathService\x12 \n" +
	"\x03Sum\x12\v.SumRequest\x1a\f.SumResponse\x12 \n" +
	"\x03Pow\x12\v.SumRequest\x1a\f.SumResponse\x12\"\n" +
	"\x05Minus\x12\v.SumRequest\x1a\f.SumResponseB\x19Z\x17myfirstserviceapp/protob\x06proto3"
...
var file_proto_math_proto_depIdxs = []int32{
	...
	0, // 1: MathService.Pow:input_type -> SumRequest
	0, // 2: MathService.Minus:input_type -> SumRequest
	1, // 3: MathService.Sum:output_type -> SumResponse
	1, // 4: MathService.Pow:output_type -> SumResponse
	1, // 5: MathService.Minus:output_type -> SumResponse
